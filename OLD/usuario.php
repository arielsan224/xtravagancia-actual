...
?>
        ...
        <table class="table table-inverse " >
          ...
          <tbody>
	     <?php
			$user = $MySQLiconn->query("SELECT us.id_usuario,us.nombre, us.apellido,us.password,us.email, 
...
order by us.id_usuario limit $offset,$limit");
			$total_user = $MySQLiconn->query("SELECT us.id_usuario FROM usuario as us
inner join tipo_usuario as tu on us.id_tipo_usuario = tu.id_tipo_usuario
inner join estatus as es on us.id_estatus=es.id_estatus");

			$total= $total_user-> num_rows;
            ...
            <tr>
              ...
              <td width="10%"><a href="?edit=<?php echo $row['id_usuario']; ?>" onclick="return confirm('Estas seguro que desea editar!'); " >edit</a></td>
    		  <td width="10%"><a href="?del=<?php echo $row['id_usuario']; ?>" onclick="return confirm('Estas seguro que desea borrar el registro !'); " >delete</a></td>
            </tr>
            <?php
			}
			?>
