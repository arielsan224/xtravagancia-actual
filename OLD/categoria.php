            ...
            <div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="descripcion" placeholder="Nombre categoria" name="descripcion" value="<?php if(isset($_GET['edit'])) echo $getROW['descripcion'];  ?>" required>
								</div>
						</div>
...
?>
        ...
        <table class="table table-inverse " 
          ...
          <tbody>
	     <?php
			$res = $MySQLiconn->query("SELECT * FROM categoria limit $offset,$limit");
			$total_mun = $MySQLiconn->query("SELECT id_categoria FROM categoria");
            ...
            <tr>
              ...
              <td width="10%"><a href="?edit=<?php echo $row['id_categoria']; ?>" onclick="return confirm('Estas seguro que desea editar!'); " >edit</a></td>
    		  <td width="10%"><a href="?del=<?php echo $row['id_categoria']; ?>" onclick="return confirm('Estas seguro que desea borrar el registro !'); " >delete</a></td>
            </tr>
            <?php
			}
			?>
