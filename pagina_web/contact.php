	...
	<div class="row">
		<div class="col-md-8 col-sm-8">
			<div class="form_title">
				...
				<p>
					We will be communicating with you as soon as possible.
				</p>
			</div>
			<div class="step">
                ...
                <form role="form" action="php/contacto.php" method="POST" id="contacto" title="contacto">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Phone</label>
								<input type="text" id="phone_contact" name="phone_contact" class="form-control" placeholder="Enter Phone number" required>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
                            ...
                            <input class="btn btn-primary" type="submit" name="enviar" tabindex="7" value="Send">&nbsp <input type="reset" tabindex="8" class="btn btn-primary" value="Clear">
		...
		<div class="col-md-4 col-sm-4">
			<div class="box_style_1">
				...
				<p>
					La merced church 1 block west , 2 1/2 block south, house number 303, Granada
				</p>
				<hr>
			...
			<div class="box_style_4">
				...
				<small>Monday to Sunday 6.00am - 11pm</small>
			</div>
		</div><!-- End col-md-4 -->
	</div><!-- End row -->
</div><!-- End container -->
