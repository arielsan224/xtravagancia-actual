            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main">
                        From/per person <small>(Minimal 4 Persons)</small><span><sup>$</sup>52</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-8" id="single_tour_desc">
            <div id="single_tour_feat">
                <ul>
                    <li><i class="icon_set_1_icon-30"></i>Walking tour</li>
                    <li><i class="icon_set_1_icon-83"></i>4 Hours</li>
                    <li><i class="icon_set_1_icon-13"></i>Accessibiliy</li>
                    <li><i class="icon_set_1_icon-82"></i>144 Likes</li>
                    <li><i class="icon_set_1_icon-34"></i>Pictures</li>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="list_ok">
                                <li>Private transport (roundtrip)</li>
                                <li>Tour Guide</li>
                                <li>Entrance fee</li>
                                </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="list_ok">
                                <li>Bring sweater, sports shoes, water.</li>
                                <li>Appropriate Ages: 10-65 years old.</li>
                                <li>Duration: 4 hours</li>
                                <li>Minimum: 4 persons</li>
                                </ul>
                        </div>
                        <!--<div class="col-md-6 col-sm-6">
                            <ul class="list_ok">
