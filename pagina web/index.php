...
//}
//else 
if (lenguage.indexOf('es') > -1){
  window.location = 'es/index';
}
//else if (lenguage.indexOf('fr') > -1){
//  window.location = 'fr/index';
//}
...
<![endif]-->
    ...
    <div class="container margin_60">
        ...
        <div class="row">
                ...
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        ...
                        <div class="short_info">
                            <i class="icon_set_1_icon-30"></i>Walking tour <span class="price"><sup>$</sup>30</span>
                        </div>
                        </a>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="laguna_apoyo">
                        <img src="img/lagunalist.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
                            <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>25</span>
                        </div>
                        </a>
                    </div>
                    <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="mombacho">
                        <img src="img/mombacholist.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <!--<div class="badge_save">Save<strong>30%</strong></div>-->
                        <div class="short_info">
                            <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>100</span>
                        </div>
                        </a>
                    </div>
                    <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
              <div class="tour_container">
                <div class="ribbon_3 popular"><span>Popular</span></div>
                <div class="img_container"> <a href="leon"> <img src="img/leonlist.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <!--<div class="badge_save">Save<strong>30%</strong></div>-->
                  <div class="short_info"> <i class="icon_set_1_icon-44"></i>Historic Buildings<span class="price"><sup>$</sup>150</span> </div>
                </a> </div>
                <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="las_isletas">
                        <img src="img/isletaslist.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <!--<div class="badge_save">Save<strong>20%</strong></div>-->
                        <div class="short_info">
                            <i class="icon_set_2_icon-108"></i>Water tour<span class="price"><sup>$</sup>20</span>
                        </div>
                        </a>
                    </div>
                    <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="ometepe">
                        <img src="img/ometepelist.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
                            <i class="icon_set_1_icon-30"></i>Water tour<span class="price"><sup>$</sup>150</span>
                        </div>
                        </a>
                    </div>
                    <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="tour_container">
					<div class="ribbon_3"><span>Top rated</span></div>
                    <div class="img_container">
                        <a href="san_juan_del_sur">
                        <img src="img/sanjuanlist.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
                            <i class="icon_set_2_icon-108"></i>Beach<span class="price"><sup>$</sup>100</span>
                        </div>
                        </a>
                    </div>
                    <div class="tour_title">
          ...
          <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
              <div class="tour_container">
                <div class="ribbon_3"><span>Top rated</span></div>
                <div class="img_container"> <a href="granada"> <img src="img/granadalist.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <div class="short_info"> <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>25</span> </div>
                </a> </div>
                <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
              <div class="tour_container">
                <div class="ribbon_3"><span>Top rated</span></div>
                <div class="img_container"> <a href="estiloeleda"> <img src="img/masayalist.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <div class="short_info"> <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>70</span></div>
                </a></div>
                <div class="tour_title">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
              <div class="tour_container">
                <div class="ribbon_3"><span>Top rated</span></div>
                <div class="img_container"> <a href="chocoyero"> <img src="img/slider_single_tour/chocoyero/1_medium.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <div class="short_info"> <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>60</span></div>
                </a></div>
                <div class="tour_title">
                  <h3><strong>Chocoyero</strong> tour</h3>
                  <div class="rating"> <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><small>(100)</small></div>
                  <!-- end rating -->
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
              <div class="tour_container">
                <div class="ribbon_3"><span>Top rated</span></div>
                <div class="img_container"> <a href="sandboard"> <img src="img/slider_single_tour/cerro_negro/6_medium.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <div class="short_info"> <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>100</span></div>
                </a></div>
                <div class="tour_title">
                  <h3><strong>SandBoard</strong> tour</h3>
                  <div class="rating"> <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><small>(100)</small></div>
                  <!-- end rating -->
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
              <div class="tour_container">
                <div class="ribbon_3"><span>Top rated</span></div>
                <div class="img_container"> <a href="travesia"> <img src="img/slider_single_tour/mariposa/1_medium.jpg" width="800" height="533" class="img-responsive" alt="image">
                  <div class="short_info"> <i class="icon_set_1_icon-30"></i>Walking tour<span class="price"><sup>$</sup>150</span></div>
                </a></div>
                <div class="tour_title">
        ...
        <p class="text-center add_bottom_30">
            <a href="all_tours_list" class="btn_1 medium"><i class="icon-eye-7"></i>View all tours  </a>
        </p>
<!-- End row -->    </div><!-- End container -->
    ...
    <div class="white_bg">
        <div class="container margin_60">
            <div class="main_title">
                <h2>Our <span>Transfers</span> offers</h2>
                <p>
                    We offer transfers from Granada, safe and quality service.
                </p>
            </div>
           ...
           <div class="row add_bottom_45">
                ...
                <div class="col-md-4"><i></i>Destination</div><div class="col-md-4"><i></i>Rate for 1-3 people</div><div class="column"><i></i>Rate for 4-6 people</div>
                <ul>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Airport</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  $45</i><i class="especialright">$70</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Masaya</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  $25</i><i class="especialright">$40</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>San Jorge</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp $55</i><i class="especialright">$100</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>San Juan del Sur</i><i class="especialcenter"> $80</i><i class="especialright">$160</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Leon</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  $120</i><i class="especialright">$200</i></a>
                        </li>
                        </ul>
                </div>
                <div class="col-md-6 other_tours">
                <div class="col-md-4 other_tours"><i></i>Destination</div><div class="col-md-4"><i></i>Rate for 1-3 people</div><div class="column"><i></i>Rate for 4-6 people</div>
                    <ul>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Montelimar</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  $100</i><i class="especialright">$150</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Matagalpa</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp $120</i><i class="especialright">$180</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Estelí</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp $120</i><i class="especialright">$180</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Selva Negra</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp  $120</i><i class="especialright">$180</i></a>
                        </li>
                        <li><a href="#"><i class="especialleft"><i class="icon_set_1_icon-21"></i>Costa Rica</i><i class="especialcenter">&nbsp &nbsp &nbsp &nbsp &nbsp  $275</i><i class="especialright">$375</i></a>
                        </li>
                    </ul>
                </div>
</div><!-- End row -->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="img/buseleda.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                    <h4><span>Sightseen tour</span> booking</h4>
                    <p>
                        the best outdoor tours.
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="img/transfereleda.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                    <h4><span>Transfer</span> booking</h4>
                    <p>
                        We offer safe transportation service.
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="img/guideeleda.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                    <h4><span>Tour guide</span> booking</h4>
                    <p>
                        
						We are specialists in Eco-tourism.
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                    ...
                    <p>
                        We offer you accommodation in the best hotels in Granada.
                    </p>
                </div>
            </div><!-- End row -->
        </div><!-- End container -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 wow zoomIn" data-wow-delay="0.2s">
                <div class="feature_home">
                    ...
                    <p>
						...
						Discover our selection of tours and know our Nicaragua with style and security.<br><br>
                    </p>
                    <a href="about.php" class="btn_1 outline">Read more</a>
                </div>
            </div>
            ...
            <div class="col-md-4 wow zoomIn" data-wow-delay="0.4s">
                <div class="feature_home">
                    ...
                    <p>
                         TripAdvisor gives us a Certificate of Excellence to accommodations, attractions and restaurants thanks to great reviews from travelers.
                    </p>
            ...
            <div class="col-md-4 wow zoomIn" data-wow-delay="0.6s">
                <div class="feature_home">
                    ...
                    <p>
                         24-Hour Shuttle Service. <br><br><br>
                    </p>
                    <a href="about.php" class="btn_1 outline">Read more</a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div id="social_footer">
                        <ul>
                            ...
                            <li><a href="http://eleda-transporte.negocio.site/"><i class="icon-google"></i></a></li>
