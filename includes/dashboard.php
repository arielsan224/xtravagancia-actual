...
<head>
  ...
  <link rel="stylesheet" href="../bower_components/Responsive-2.2.0/css/responsive.bootstrap.min.css"/>
...
<!--  <script src="../bower_components/fileinput/js/locales/es.js"></script>-->
  ...
  <![endif]-->
 <style>
	  .ttwarning + .tooltip > .tooltip-inner {
    ...
    font-size: 20px;*/
	 ...
	 .ttprimary + .tooltip > .tooltip-inner {
    	background-color: #337ab7; 
    	}
	 .ttsuccess + .tooltip > .tooltip-inner {
    	background-color: #5cb85c; 
    	}
	 .ttdanger + .tooltip > .tooltip-inner {
